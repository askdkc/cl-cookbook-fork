...
* [Common Lisp ライブラリ Read the Docs](https://common-lisp-libraries.readthedocs.io/) - よく使われるライブラリのドキュメントを、現代的で見やすい Read The Docs style に移植したものです。
* [lisp-tips](https://github.com/lisp-tips/lisp-tips/issues/)
* [Common Lisp and CLOG チュートリアル series](https://github.com/rabbibotton/clog/blob/main/LEARN.md): Common Lisp と CLOG のチュートリアルです。CLOG は web technologies に基づく Common Lisp 向け GUI 風ライブラリです。
...
* [Programming Algorithms](https://leanpub.com/progalgs) - Lisp の例を使って効率的なプログラムを書くための包括的な guide です。
...
そう、あなたに話しています。私たちは contributor を必要としています。足りない章を書いて追加する、未解決の質問を見つけて答えを提供する、bug、typo、文法エラーを見つけて報告する、などです。formatting は心配しないでください。望むなら plain text を送るだけでもかまいません。その後の整形はこちらで対応します。
